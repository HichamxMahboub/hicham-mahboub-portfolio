    ...
    <main className="dark min-h-screen bg-[#080a0f] text-white">
      ...
      >
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <Button href={localizePath(locale, "/projects")} size="lg">View Projects</Button>
          <Button href={localizePath(locale, "/contact")} variant="outline" size="lg">Contact Me</Button>
          <Button href={localizePath(locale, "/")} variant="ghost" size="lg">Back Home</Button>
        </div>
      </PageHero>
